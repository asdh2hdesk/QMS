...
class Pfmea(models.Model):
    ...
    operation_ids = fields.One2many(
        comodel_name='his.pfmea.operations',
    ...
    def create(self, vals_list):
        records = super(Pfmea, self).create(vals_list)
    ...
    def action_generate_excel_report(self):
        ...
        return {
            ...
            "target": "self",
            "url": "/web/content?model=his.pfmea&download=true&field=generate_xls_file&filename={filename}.xlsx&id={pid}".format(
                filename="PFMEA", pid=self[0].id),
        }


class Pfmea_operation(models.Model):
    _name = "his.pfmea.operations"
    ...
    pfmea_id = fields.Many2one('his.pfmea', 'PFMEA')
    operation_lines_ids = fields.One2many(
        comodel_name='his.pfmea.operations.line',
...
class PfmeaOperationLine(models.Model):
    _name = "his.pfmea.operations.line"
    _description = "PFMEA Operation Line"
    # _inherit = "translation.mixin"

    pfmea_operation_id = fields.Many2one('his.pfmea.operations', 'PFMEA Operation Line')
